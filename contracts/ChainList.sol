...
contract ChainList is Ownable {
  ...
  // modifiers -- Now in Ownable
  //modifier onlyOwner() {
    //require(msg.sender == owner);
    //_;
  //}

  // constructor -- Now in Ownable
  //Note that the only role of the this method was to save the msg.sender
  //When the ChainList contract is deployed the parent constructor is called (Ownable contract)
  ...
  function kill() public onlyOwner{
    ...
    //Not use since we use modifier onlyOwner() : Here we use Aspect programming provide by solidity
    //require(msg.sender == owner);
